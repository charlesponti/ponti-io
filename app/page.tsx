...
export default function Home() {
	...
	return (
		<div className="container px-4 my-24 mx-auto flex flex-col gap-4 min-h-screen text-bone-100">
			{/* Hero Section */}
			<motion.section
			...
			>
				<h1 className="pb-4 tracking-tighter md:text-center font-serif">
					<motion.span
						className="text-5xl lg:text-7xl tracking-tighter block bg-gradient-to-r from-sage-200 via-olive-200 to-bone-300 text-transparent bg-clip-text font-serif"
				...
				<p className="text-lg lg:text-xl text-sage-300 tracking-wide font-light mb-12 ml-1 relative md:text-center font-sans">
			...
			<motion.section
				id="contact"
				className="mx-auto px-4 py-4 text-center"
				{...fadeInUp}
			>
				<div className="flex flex-col items-center gap-4">
					...
					>
						<span className="absolute inset-0 opacity-50 bg-gradient-to-r from-olive-200/10 via-bone-200/15 to-sage-200/10 rounded-xl group-hover:opacity-70 transition-all duration-300" />
						<span className="relative z-10 text-bone-100">Get Started</span>
					</a>
					<p className="text-sage-400 font-light">Response within 24 hours</p>
				</div>
			</motion.section>
		</div>
	);
