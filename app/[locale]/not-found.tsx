	...
	return (
		<section className="bg-black text-white">
			<div className="flex min-h-screen flex-col items-center justify-center text-center px-6">
				<RiAlarmWarningFill
					size={60}
					className="animate-pulse text-white opacity-80"
				/>
				...
				<Link
					className="mt-12 font-mono text-sm uppercase tracking-[0.2em] border-b border-white pb-1 hover:bg-white hover:text-black transition-all px-2"
					href="/"
				>
					Return to Root
				</Link>
